...
export function initModels(sequelize: Sequelize) {
  ...
  product_mapping_details.belongsTo(product_mappings, { as: "product_mapping", foreignKey: "product_mapping_id"});
  product_mappings.hasMany(product_mapping_details, { as: "product_mapping_details", foreignKey: "product_mapping_id"});
